import "./ModalAddProduto.css";

function ModalAddProduto({ setIsVisible1 }) {
    return (
        <div className="modal-container">
            <div className="modal-add-produto">
                <button className="modal--add-produto__cancelar" onClick={() => setIsVisible1(false)}>Cancelar</button>
